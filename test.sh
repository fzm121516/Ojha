...
CUDA_VISIBLE_DEVICES=0 python mytrain.py --name=clip_vitl14 --wang2020_data_path=/home/fanzheming/zm/NPR-DeepfakeDetection/dataset --data_mode=wang2020  --arch=CLIP:ViT-L/14  --fix_backbone
